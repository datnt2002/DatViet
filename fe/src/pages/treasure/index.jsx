  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="bg-contain bg-no-repeat h-96 w-2/3 rounded-2xl absolute top-24 right-9 p-6"
      >
        <h1 className="text-2xl font-dancing pt-12 pl-4 pb-3">
          Câu số 1: Questionafe awfawfawfwafwe
        </h1>
        <img
      ...
      <div className="absolute top-[29rem] right-9 w-2/3 h-auto pb-8  pl-10 pt-6 rounded-2xl ">
